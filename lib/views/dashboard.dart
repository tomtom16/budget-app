...
class _DashboardViewState extends State<DashboardView> {
  ...
  Future<void> _fetchPieData(DateTime date) async {
    try {
      categoryData = await BudgetService.getExpenseStatistics(_selectedRange, date);
      setState(() {
        _isLoading = false;
      });
    } catch (e) {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              // Dashbaord headline
              Center(
                child: Text(isMonthly ? 'Monthly Overview: ${currentDate.year}-${currentDate.month}' : 'Yearly Overview: ${currentDate.year}', style: Theme
                    .of(context)
                    .textTheme
                    .headlineSmall),
              ),
              ...
              const SizedBox(height: 24),
              Text('Category Breakdown', style: Theme
                  .of(context)
                  .textTheme
                  .titleMedium),
              const SizedBox(height: 12),
